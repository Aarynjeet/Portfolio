 ...
 * Date:   2026-03
 *
 * Receives POST parameters from index.php:
 *   - email     : user's email address
 *   - birthdate : YYYY-MM-DD birth date (acts as password)
 *
 * Three outcomes:
 *   1. Email + birthdate match   → returning user, link to play.php
 *   2. Email not in DB           → new user registered, link to play.php
 *   3. Email taken, wrong date   → error message, link back to index.php
 *
 * Uses PDO prepared statements. Filters all HTTP input.
 */
