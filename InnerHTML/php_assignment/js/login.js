 ...
 *   2. Has alphanumeric characters before the @
 *   3. Has a dot (.) in the domain part after the @ that separates
 *      alphanumeric characters — e.g. "a@b.c" is minimally valid
 *
 * The built-in type="email" allows things like "a@a" through,
 * so this extra check closes that gap.
 */
