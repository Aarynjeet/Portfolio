 ...
 * Date:   2026-03
 *
 * Displays a form asking the user for an email and birth date.
 * JavaScript validates the email format before submission.
 * On submit, the form POSTs to login.php.
 */
?>
<!DOCTYPE html>
<!--
    Memory Match Game — Login Page
    CS 1XD3 Server-side Assignment
    Author: Aarynjeet Gill
    Date:   2026-03
    Description: Landing page that collects an email address
                 and birth date (used as an insecure password).
                 Client-side JS validates email format before submit.
-->
<html lang="en">
<head>
    <meta charset="UTF-8">
